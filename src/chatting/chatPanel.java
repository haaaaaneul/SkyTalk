...
public class chatPanel extends JPanel {
	...
	public chatPanel(ChatFrame cf, String friendName) {
		...
		profile.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		textPaneChat.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		txtWrite.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
	    cf.add(txtWrite);
		...
		txtWrite.addKeyListener(new KeyListener() {
			...
			@Override
			public void keyReleased(KeyEvent e) { //ø£≈Õ≈∞ ¿‘∑¬«ÿµµ √ﬂ∞°
				if(e.getKeyChar() == '\n'){ //ø£≈Õ ¿‘∑¬ »Æ¿Œ
